...
CUDA_VISIBLE_DEVICES=1,2 bash tools/dist_train.sh configs/_my/fpn_red50_neck_512x1024_40k_cityscapes2.py 2
CUDA_VISIBLE_DEVICES=1,2 bash tools/dist_train.sh configs/_my/fpn_red50_neck_512x1024_40k_cityscapes3.py 2
